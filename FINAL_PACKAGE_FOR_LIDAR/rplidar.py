...
class RPLidar(threading.Thread):
    ...
    def iter_measurments(self, max_buf_meas=100):
    ...
    def iter_scans(self, max_buf_meas= False, min_len=1):
        ...
        for new_scan, quality, angle, distance in iterator:
            ...
            if quality > 0 and distance > 0:
                scan.append((distance ,angle))
                #self.lock.release()
                
#threading.Thread(target=_process_scan(raw)).start()
